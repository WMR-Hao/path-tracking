function [Xnext,Ynext,PSInext,vxnext,vynext,gammanext,BETA]=dynamics_model_v9_backup...
...
gammanext=( d*( Fb )+l*(F1y+F2y-F3y-F4y)) /Iz;      %  对应控制器，这里也没加前一刻状态
% gammanext=( ( d*( Fb )+l*(-F1y-F2y+F3y+F4y)) /Iz) + gamma;
